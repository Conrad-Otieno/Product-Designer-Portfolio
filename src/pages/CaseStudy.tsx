        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-4xl">
            ...
            <div className="flex flex-wrap items-center gap-4 mb-6">
              <span className="px-4 py-2 bg-forest-dark/5 rounded-full text-forest-dark/70 font-body text-sm font-medium">
                {caseStudy.category}
              </span>
              <span className="text-forest-dark/50 font-body text-sm">{caseStudy.year}</span>
              <span className="w-1 h-1 rounded-full bg-forest-dark/30" />
              <span className="text-forest-dark/50 font-body text-sm">{caseStudy.duration}</span>
            </div>

            {/* Title */}
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-sans font-bold text-forest-dark tracking-tight leading-tight mb-6">
              {caseStudy.title}
            </h1>

            {/* Client */}
            <p className="text-forest-dark/60 font-body text-lg mb-8">
              Client: <span className="text-forest-dark/80 font-medium">{caseStudy.client}</span>
            </p>

            {/* Role */}
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 pt-6 border-t border-forest-dark/10">
              <div>
                <p className="text-forest-dark/50 font-body text-sm mb-2">Role</p>
                <p className="text-forest-dark font-sans font-medium">{caseStudy.role}</p>
              </div>
              
              {caseStudy.product && (
                <div>
                  <p className="text-forest-dark/50 font-body text-sm mb-2">Product</p>
                  <p className="text-forest-dark font-sans font-medium">{caseStudy.product}</p>
                </div>
              )}
              
              {caseStudy.tools && caseStudy.tools.length > 0 && (
                <div>
                  <p className="text-forest-dark/50 font-body text-sm mb-2">Tools</p>
                  <div className="flex items-center gap-3">
                    {caseStudy.tools.map((tool, index) => (
                      <div key={index} className="relative group">
                        {tool === 'Figma' && (
                          <svg className="w-6 h-6 text-forest-dark" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <span className="absolute -bottom-8 left-1/2 -translate-x-1/2 px-2 py-1 bg-forest-dark text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
                          {tool}
                        </span>
                      </div>
                    ))}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-12 gap-8 md:gap-12 lg:gap-16">
            <div className="md:col-span-4">
              <p className="reveal text-forest-dark/50 text-xs sm:text-sm font-body uppercase tracking-widest mb-3 md:mb-4 opacity-0">Overview</p>
              <h2 className="reveal text-xl sm:text-2xl md:text-3xl font-sans font-bold text-forest-dark opacity-0">Project Summary</h2>
            </div>
            <div className="md:col-span-8">
              {caseStudy.overview.split('\n\n').map((paragraph, idx) => {
                ...
                if (paragraph.includes('\n•')) {
                  ...
                  return (
                    <div key={idx} className="reveal opacity-0 mb-6 last:mb-0">
                      {intro && (
                        <p className="text-forest-dark/80 font-body text-base md:text-lg lg:text-xl leading-relaxed mb-4">
                          {intro}
                        </p>
                      )}
                      <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3">
                        {items.map((item, itemIdx) => (
                          <li key={itemIdx} className="flex items-start gap-3 text-forest-dark/80 font-body text-base md:text-lg leading-relaxed">
                            <span className="text-forest-dark/60 mt-1.5 flex-shrink-0">•</span>
                            <span>{item.trim()}</span>
                          </li>
                        ))}
                      </ul>
                ...
                return (
                  <p key={idx} className="reveal text-forest-dark/80 font-body text-base md:text-lg lg:text-xl leading-relaxed opacity-0 mb-6 last:mb-0">
                    {paragraph}
                  </p>
                );
              })}
      ...
      <section ref={challengeRef} className="relative py-16 md:py-24 lg:py-32 px-4 sm:px-6 md:px-12 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-5xl mx-auto">
            <p className="reveal text-forest-dark/50 text-xs sm:text-sm font-body uppercase tracking-widest mb-3 md:mb-4 opacity-0">The Challenge</p>
            <h2 className="reveal text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-sans font-bold text-forest-dark leading-tight mb-8 md:mb-12 opacity-0">
              Understanding the <span className="font-serif italic font-normal text-forest-dark/60">Problem</span>
            </h2>
            ...
            {caseStudy.challenge.split('\n\n').map((paragraph, idx) => {
                              ...
                              <div className="relative p-8 md:p-10">
                                <div className="flex items-start gap-6">
                                  ...
                                  <div className="relative flex-shrink-0">
                                    <div className="w-12 h-12 rounded-xl flex items-center justify-center font-sans text-base font-bold transition-all duration-500 group-hover:scale-110 bg-forest-dark text-white" style={{
                                  ...
                                  <div className="flex-1 min-w-0">
                                    <h4 className="text-lg md:text-xl font-sans font-bold mb-3 transition-colors duration-300 text-forest-dark">
                                      {title}
                                    </h4>
                                    {description && (
                                      <p className="font-body text-sm md:text-base leading-relaxed text-forest-dark/70">
                                        {description}
                                      </p>
                                    )}
                                  </div>
              ...
              return (
                <p key={idx} className="reveal text-forest-dark/70 font-body text-base md:text-lg lg:text-xl leading-relaxed opacity-0 mb-8 max-w-3xl">
                  {paragraph}
                </p>
              );
            })}
            ...
            >
              <div className="max-w-7xl mx-auto">
                ...
                <div className="max-w-4xl mb-12 md:mb-16">
                  {phase.subtitle && (
                    <p className={`text-xs sm:text-sm font-body uppercase tracking-widest mb-3 md:mb-4 text-forest-dark/50`}>
                      {phase.subtitle}
                    </p>
                  )}
                  <h2 className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-sans font-bold leading-tight mb-4 md:mb-6 text-forest-dark`}>
                    {phase.title}
                  </h2>
                  {phase.description.split('\n\n').map((paragraph, pIdx) => {
                    ...
                    if (paragraph.trim().endsWith(':') && !paragraph.includes('\n')) {
                      return (
                        <h3 key={pIdx} className={`font-sans font-bold text-xl md:text-2xl mb-4 mt-8 first:mt-0 text-forest-dark`}>
                          {paragraph.trim()}
                        </h3>
                      );
                    }
                    ...
                    if (/^\d+\./.test(paragraph)) {
                      ...
                      return (
                        <div key={pIdx} className="mb-6 last:mb-0">
                          {intro && intro.trim() && (
                            <p className={`font-body text-base md:text-lg leading-relaxed mb-4 text-forest-dark/70`}>
                              {intro.trim()}
                            </p>
                          )}
                          <ol className="space-y-3">
                            {items.map((item, itemIdx) => {
                              ...
                              if (match) {
                                ...
                                return (
                                  <li key={itemIdx} className={`flex items-start gap-4 font-body text-base md:text-lg leading-relaxed text-forest-dark/70`}>
                                    <span className={`flex-shrink-0 w-7 h-7 rounded-lg flex items-center justify-center font-sans text-sm font-bold bg-forest-dark/10 text-forest-dark`}>
                                      {number}
                                    </span>
                    ...
                    if (paragraph.includes('\n•')) {
                      ...
                      return (
                        <div key={pIdx} className="mb-8 last:mb-0">
                          {intro && intro.trim() && (
                            <h4 className={`font-sans font-semibold text-lg md:text-xl mb-4 text-forest-dark/90`}>
                              {intro.trim()}
                            </h4>
                          )}
                    ...
                    return (
                      <p key={pIdx} className={`font-body text-base md:text-lg lg:text-xl leading-relaxed mb-6 last:mb-0 text-forest-dark/80 italic`}>
                        {paragraph}
                      </p>
                    );
                  })}
                ...
                {phase.insights && phase.insights.length > 0 && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-12">
                    {phase.insights.map((insight, idx) => (
                      <div 
                        key={idx}
                        className={`group relative transition-all duration-300 hover:scale-[1.02] bg-white border border-forest-dark/8 rounded-2xl overflow-hidden`}
                        style={{
                        ...
                        <div className="relative p-8 md:p-10">
                          <div className="flex items-start gap-6">
                            ...
                            <div className="relative flex-shrink-0">
                              ...
                              {/* Glow effect */}
                              <div className={`absolute inset-0 rounded-xl blur-xl opacity-0 group-hover:opacity-50 transition-opacity duration-500 bg-forest-dark/20`} />
                            </div>
                ...
                {phase.problemStatement && (
                  <div className={`p-8 md:p-10 rounded-2xl border-l-4 mb-8 bg-forest-dark/5 border-forest-dark`}>
                    <h5 className={`text-sm font-sans font-bold uppercase tracking-wider mb-4 text-forest-dark/70`}>
                      Problem Statement
                    </h5>
                    <p className={`font-body text-lg md:text-xl leading-relaxed text-forest-dark/90`}>
                      {phase.problemStatement}
                    </p>
                  </div>
                )}
                ...
                {(phase.productVision || phase.goals || phase.userStories) && (
                  <div className={`p-8 md:p-10 rounded-2xl mb-12 bg-forest-dark/5`}>
                    {/* Product Vision */}
                    {phase.productVision && (
                      <div className="mb-8">
                        <h5 className={`text-sm font-sans font-bold uppercase tracking-wider mb-4 text-forest-dark/70`}>
                      ...
                      <div className="mb-8">
                        ...
                        <ul className="space-y-3">
                          {phase.goals.map((goal, idx) => (
                            ...
                            >
                              <div className={`flex-shrink-0 w-7 h-7 rounded-lg flex items-center justify-center font-sans text-xs font-bold mt-0.5 bg-forest-dark/10 text-forest-dark`}>
                                {idx + 1}
                              </div>
                              <p className={`font-body text-base md:text-lg leading-relaxed flex-1 text-forest-dark/85`}>
                                {goal}
                              </p>
                            </li>
                          ))}
                    ...
                    {phase.userStories && phase.userStories.length > 0 && (
                      <div>
                        <h5 className={`text-sm font-sans font-bold uppercase tracking-wider mb-6 text-forest-dark/70`}>
                          User Stories
                        </h5>
                        ...
                        <div className={`rounded-2xl overflow-hidden bg-white shadow-lg`}>
                          {/* Table Header */}
                          <div className={`grid grid-cols-1 md:grid-cols-[1.2fr,1fr] bg-forest-dark/5 border-b border-forest-dark/10`}>
                            <div className={`px-8 py-5 font-sans font-bold text-xs uppercase tracking-widest md:border-r text-forest-dark/70 border-forest-dark/10`}>
                              User Story
                            </div>
                            <div className={`px-8 py-5 font-sans font-bold text-xs uppercase tracking-widest text-forest-dark/70`}>
                              Solution Feature
                            </div>
                          </div>
                          ...
                          {phase.userStories.map((item, idx) => (
                            <div 
                              ...
                              } border-forest-dark/5 hover:bg-forest-dark/5`}
                            >
                              {/* User Story Column */}
                              <div className={`px-8 py-8 md:border-r flex flex-col justify-center border-forest-dark/10`}>
                                <div className="flex items-start gap-4">
                                  <div className={`flex-shrink-0 w-7 h-7 rounded-lg flex items-center justify-center text-xs font-sans font-bold mt-0.5 bg-forest-dark/10 text-forest-dark`}>
                                    {idx + 1}
                                  </div>
                                  <p className={`font-body text-base leading-relaxed italic text-forest-dark/90`}>
                                    "{item.story}"
                                  </p>
                                </div>
                              </div>
                              ...
                              <div className="px-8 py-8 flex flex-col justify-center">
                                <p className={`font-body text-base leading-relaxed text-forest-dark/85`}>
                                  <span className={`font-sans font-bold block mb-2 text-forest-dark`}>
                                    {item.feature.split(':')[0]}
                                  </span>
                                  <span className={`text-forest-dark/75`}>
